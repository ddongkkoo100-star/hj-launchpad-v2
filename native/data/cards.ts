// HJ 런치패드 — 카드 데이터 (TypeScript)
// 원본: hj-launchpad-v2/data/cards.js 에서 포팅
...
export interface Card {
  ...
  enabled: boolean;
  defenseLine: boolean;
  isTasksTarget: boolean;
  tasksGroup: string | null;
...
export const VISIBLE_CARDS = CARDS.filter(c => c.visible && c.enabled);
